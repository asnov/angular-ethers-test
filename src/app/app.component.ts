...
import { LiquidLong, Provider, Scheduler, TimeoutScheduler, JsonRpcProvider, Signer } from '@keydonix/liquid-long-client-library';
...
export class AppComponent {
  ...
  async testLiquidLong() {
    ...
    const ll: LiquidLong = new LiquidLong(scheduler, provider, signer, liquidLongAddress, defaultEthPriceInUsd, defaultProviderFeeRate);
    await ll.awaitReady;
  }
